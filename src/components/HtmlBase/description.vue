<template>
  <div class=" draggable resizable text" id="desc"
    style="font-family:Cubic; font-size: 12px; z-index: 4; line-height: 16px;background-color: #000c13; z-index: 3;border: 3px solid transparent;border-image: linear-gradient(to right, #3f0081, #992ecf);border-image-slice: 1; padding: 7px;min-height:min-content; color: #8aadbe; white-space: pre-line;">
