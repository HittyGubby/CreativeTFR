<template>
    <Dialog v-model:visible="dialogVisible" :style="{ width: '90%', fontFamily: 'Cubic', opacity: 0.9 }" header="国家精神管理"
        class="spirit-manager-dialog" @hide="handleClose" @show="handleShow">
